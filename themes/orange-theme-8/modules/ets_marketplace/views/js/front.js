...
$(document).ready(function(){
    if ($('#skill-editor').length) {
        var skill_editor = ace.edit('skill-editor')
        skill_editor.setTheme("ace/theme/chrome");
        skill_editor.session.setMode("ace/mode/json");
        skill_editor.session.on('change', function(delta) {
            $('[name="product_skill"]').html(skill_editor.getValue())
        });
    }
...
function ets_mp_displayProductType()
{
    ...
    $('#skill-form-group').toggle(product_type==3)
    ...
    $('.ets_mp_tab[data-tab="Quantities"]').html(
        product_type==2 ? virtual_product_text : 'Skill'
    );
    ...
    $('.form-group.ets_mp_show_variations').hide();
    $('.form-group.ets_mp_form_pack_product').hide();
    const showVirtualProductContent = $('input[name="is_virtual_file"]:checked').val()==1
    $('#virtual_product_content').toggle(showVirtualProductContent)
    $('input[name="is_virtual_file"]').click(function(){
        const showVirtualProductContent = $(this).val()==1
        $('#virtual_product_content').toggle(showVirtualProductContent)
    });

    // TODO: toggle AceEditor for skills
}
