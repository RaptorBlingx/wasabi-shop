                        ...
                        <div class="col-md-6">
                            <fieldset class="form-group">
                                ...
                                <div class="input-group datepicker">
                                    <input class="form-control" autocomplete="off" id="form_step3_virtual_product_expiration_date" name="virtual_product_expiration_date" placeholder="YYYY-MM-DD" type="text" />
