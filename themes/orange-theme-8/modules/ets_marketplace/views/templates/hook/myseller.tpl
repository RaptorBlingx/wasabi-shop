                        ...
                        <div class="row myseller-list">
                            <div class="links row">
                                {foreach from=$seller_pages item='page'}
                                	<a id="ets_mp_{$page.page|escape:'html':'UTF-8'}-link" href="{if isset($page.link)}{$page.link|escape:'html':'UTF-8'}{else} {$link->getModuleLink('ets_marketplace',$page.page)|escape:'html':'UTF-8'}{/if}" class="seller_link col-12 col-lg-6 col-xl-4" {if isset($page.new_tab) && $page.new_tab} target="_blank"{/if}>
                                        <span class="link-item">
                                            <div><i class="mp-seller-{$page.page|escape:'html':'UTF-8'}icons"></i></div>
                                            <div class="h4 mt-2">{$page.name|escape:'html':'UTF-8'}</div>
                                        </span>
                                	</a>
                                 {/foreach}
                            </div>
