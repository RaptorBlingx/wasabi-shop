 ...
 *}
<section class="contact-form section-padding pt-0">
  <form class="js-customer-form needs-validation" action="{$urls.pages.contact}" method="post" {if $contact.allow_file_upload}enctype="multipart/form-data"{/if} novalidate autocomplete="false">
      ...
      {if !$notifications || $notifications.nw_error}
        <section class="form-fields">
          <h2 class="h2 text-center">{l s='Contact us' d='Shop.Theme.Global'}</h2>
          ...
          <input class="btn btn-primary d-block mx-auto" type="submit" name="submitMessage" value="{l s='Send' d='Shop.Theme.Actions'}">
        </section>
