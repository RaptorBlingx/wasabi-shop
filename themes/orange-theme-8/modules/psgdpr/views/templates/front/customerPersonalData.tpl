    ...
    <section class="page_content">
        <div class="row">
            <div class="col-12 psgdprinfo17">
                ...
                <div>
                    <a id="exportDataToCsv" class="btn btn-primary psgdprgetdatabtn17 my-1" target="_blank" href="{$psgdpr_csv_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO CSV' mod='psgdpr'}</a>
                <a id="exportDataToPdf" class="btn btn-primary psgdprgetdatabtn17 my-1" target="_blank" href="{$psgdpr_pdf_controller|escape:'htmlall':'UTF-8'}">{l s='GET MY DATA TO PDF' mod='psgdpr'}</a>
                </div>
            </div>
            <div class="col-12 psgdprinfo17">
