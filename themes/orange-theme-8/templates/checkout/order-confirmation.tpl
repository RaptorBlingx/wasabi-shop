...
{block name='page_content_container'}
  <section id="content" class="page-content page-order-confirmation card mb-3 p-4 p-lg-5">
  ...
  {block name='hook_payment_return'}
    ...
    <section id="content-hook_payment_return" class="card mb-3 definition-list p-4 p-lg-5">
