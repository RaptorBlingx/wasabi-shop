{**
   ...
   <div class="images-container">
     {block name='product_cover'}
           {if $product.default_image.legend}
               {$image_alt = $product.default_image.legend}{else}{$image_alt = $product.name}
           {/if}
                       ...
                       <div class="">
                           {if $product.default_image}
                               <img 
                                   ...
                                   {$product.default_image.bySize.medium_default.url} 180w,
                                   {$product.default_image.bySize.medium_default.url} 300w,
                                   {$product.default_image.bySize.large_default.url} 540w"
                           ...
                           <div class="product-img">
                               <div class="rc">
                                   <img 
                                       ...
                                       {if !$smarty.foreach.images.first && !$product.default_image}data-{/if}srcset="{$image.bySize.large_default.url} 452w,
                                       {$image.bySize.medium_default.url} 180w,
                                       {$image.bySize.medium_default.url} 300w,
                                       {$image.bySize.large_default.url} 540w"
                                       {if !$smarty.foreach.images.first && !$product.default_image}data-{/if}src="{$image.bySize.large_default.url}"
