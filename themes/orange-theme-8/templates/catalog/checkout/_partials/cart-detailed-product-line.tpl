 ...
 *}
<div class="product-line-grid row no-gutters align-items-center">
    <div class="col-12 col-lg-7">
        <div class="media row align-items-center flex-nowrap">
            <img src="{$product.cover.bySize.small_default.url}" alt="{$product.name|escape:'quotes'}"
                 class="product-line__img w-100 col-auto" style="max-width: 120px;">
            <div class="media-body product-line__body col">
