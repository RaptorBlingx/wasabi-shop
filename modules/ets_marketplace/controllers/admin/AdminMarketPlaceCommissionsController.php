...
if (!defined('_PS_VERSION_'))
    	exit;
/**
 * Class AdminMarketPlaceCommissionsController
 * @property \Ets_marketplace $module
 */
class AdminMarketPlaceCommissionsController extends ModuleAdminController
{
    ...
    public function renderList()
    {
        ...
        $this->context->smarty->assign(
            array(
                'ets_mp_body_html'=> $this->module->renderCommission(),
            )
        );
        $html ='';
