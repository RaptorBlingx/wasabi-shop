                        ...
                        <div class="row">
        					...
        					<div class="col-lg-8 col-sm-6 seller-social">
                                {if $registration->link_facebook}
                                    <a class="facebook" href="{$registration->link_facebook|escape:'html':'UTF-8'}" target="_blank"><i class="icon icon-facebook fa fa-facebook" title="{l s='Facebook' mod='ets_marketplace'}"></i></a>
                                {/if}
                                {if $registration->link_google}
                                    <a class="google" href="{$registration->link_google|escape:'html':'UTF-8'}" target="_blank"><i class="icon icon-google fa fa-google" title="{l s='Google' mod='ets_marketplace'}"></i></a>
                                {/if}
                                {if $registration->link_instagram}
                                    <a class="instagram" href="{$registration->link_instagram|escape:'html':'UTF-8'}" target="_blank"><i class="icon icon-instagram fa fa-instagram" title="{l s='Instagram' mod='ets_marketplace'}"></i></a>
                                {/if} 
                                {if $registration->link_twitter}
                                    <a class="twitter" href="{$registration->link_twitter|escape:'html':'UTF-8'}" target="_blank"><i class="icon icon-twitter fa fa-twitter" title="{l s='Twitter' mod='ets_marketplace'}"></i></a> 
                                {/if}
                            </div>
                        </div>
                    {/if}
