...
{if isset($sellers) && $sellers}
    <div class="home-top-sellers">
        <h4 class="follow-title">{l s='Top shops' mod='ets_marketplace'}</h4>
    	<div id="page_home_top_seller" class="list-sellers sellers ets_marketplace_product_list_wrapper slide">
                  ...
                  <div class="seller-miniature">
                        <div class="thumbnail-container">
                            <a class="thumbnail seller-thumbnail" href="{$seller.link|escape:'html':'UTF-8'}" tabindex="0">
                                <img alt="{$seller.shop_name|escape:'html':'UTF-8'}" style="width:250px" src="{$link->getMediaLink("`$smarty.const.__PS_BASE_URI__`img/mp_seller/`$seller.shop_logo|escape:'html':'UTF-8'`")}" />
                            </a>
