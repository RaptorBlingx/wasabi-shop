                                                                    ...
                                                                    {if $row.id_seller}
                                                                        ...
                                                                        <li {if $row.active!=-1} style="display:none;"{/if}>
                                                                            <span class="btn btn-default approve_registration action_decline_product" data-id="{$row.$identifier|intval}">
                                                                                <i class="icon icon-ban"></i> {l s='Decline' mod='ets_marketplace'}
                                                                            </span>
                                                                            <div class="approve_registration_form" style="display:none">
                                                                                <div class="ets_mp_close_popup" title="Close">{l s='Close' mod='ets_marketplace'}</div>
                                                                                <div class="form-group">
                                                                ...
                                                                {foreach from=$actions item='action' key='key'}
                                                                    {if $key!=0}
                                                                        ...
                                                                        {if $action=='assign' && !$row.id_customer_seller}
                                                                            <li><a data-id_product="{$row.id_product|intval}" class="btn btn-default btn-assign-product" href="#"><i class="fa fa-copy icon-copy"></i> {l s='Assign product' mod='ets_marketplace'}</a></li>
                                                                        {/if}
                                                                        {if $action=='delete_shop'}
                                                                            <li><a class="btn btn-default" onclick="return confirm('{l s='Do you want to delete this shop?' mod='ets_marketplace'}');" href="{$currentIndex|escape:'html':'UTF-8'}&{$identifier|escape:'html':'UTF-8'}={$row.$identifier|escape:'html':'UTF-8'}&del=yes{if isset($row.type)}&type={$row.type|escape:'html':'UTF-8'}{/if}"><i class="fa fa-times icon-times"></i> {l s='Delete shop' mod='ets_marketplace'}</a></li>
                                                                        {/if}
                                                                        {if $action=='delete_product'}
                                                                            <li><a class="btn btn-default" onclick="return confirm('{l s='Do you want to delete all products in shop?' mod='ets_marketplace'}');" href="{$currentIndex|escape:'html':'UTF-8'}&{$identifier|escape:'html':'UTF-8'}={$row.$identifier|escape:'html':'UTF-8'}&delproducts=yes{if isset($row.type)}&type={$row.type|escape:'html':'UTF-8'}{/if}"><i class="fa fa-eraser icon-eraser"></i> {l s='Delete products' mod='ets_marketplace'}</a></li>
                                                                        {/if}
                                                                        {if $action=='delete_commission'}
                                                                            <li><a class="btn btn-default" onclick="return confirm('{l s='Do you want to delete all commissions in shop?' mod='ets_marketplace'}');" href="{$currentIndex|escape:'html':'UTF-8'}&{$identifier|escape:'html':'UTF-8'}={$row.$identifier|escape:'html':'UTF-8'}&delcommissions=yes{if isset($row.type)}&type={$row.type|escape:'html':'UTF-8'}{/if}"><i class="fa fa-user-times icon-user-times"></i> {l s='Delete commissions' mod='ets_marketplace'}</a></li>
                                                                        {/if}
                                                                        {if $action=='delete_all'}
                                                                            <li><a class="btn btn-default" onclick="return confirm('{l s='Do you want to delete this shop and all data?' mod='ets_marketplace'}');" href="{$currentIndex|escape:'html':'UTF-8'}&{$identifier|escape:'html':'UTF-8'}={$row.$identifier|escape:'html':'UTF-8'}&delall=yes{if isset($row.type)}&type={$row.type|escape:'html':'UTF-8'}{/if}"><i class="fa fa-trash icon-trash"></i> {l s='Delete all' mod='ets_marketplace'}</a></li>
                                                                        {/if}
