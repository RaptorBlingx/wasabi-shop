        ...
        $.ajax({
            ...
            success: function(json){
                ...
                if(json.success)
                {
                    $.growl.notice({ message: json.success });
                    $('.ets_mp_popup').hide();
                    $('#list-mp_products tr[data-id="'+json.id_product+'"] td.active i.fa').removeClass('icon-clock-o').removeClass('fa-clock-o').addClass('icon-ban fa-ban').parent().removeClass('.action-pending').addClass('action-disabled');
        ...
        $.ajax({
            ...
            success: function(json){
                ...
                if(json.success)
                {
                    $.growl.notice({ message: json.success });
                    $('.ets_mp_popup').hide();
                    $('#list-mp_products tr[data-id="'+id_product+'"] td.active i.fa').removeClass('icon-clock-o').removeClass('fa-clock-o').addClass('icon-ban fa-ban').parent().removeClass('.action-pending').addClass('action-disabled');
                    ...
                    $('#list-mp_products tr[data-id="'+id_product+'"] td.active a').html('<i class="icon-check"></i>');
                    $this.parent().hide();
                }
                if(json.errors)
                {
